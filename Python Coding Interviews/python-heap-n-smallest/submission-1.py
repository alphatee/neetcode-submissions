...
def get_min_element(arr: List[int]) -> int:
    # while this assignment is making it a point in all the many uses to get out
    # of nsmallest(), I could have just returned min(arr)
    # because it is more pythonic and clear
